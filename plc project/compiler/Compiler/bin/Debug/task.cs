...
namespace com.calitha.goldparser
{
    ...
    enum SymbolConstants : int
    {
        ...
        SYMBOL_MAT          = 41, // MaT
        SYMBOL_RIX          = 42, // riX
        SYMBOL_SWITCH       = 43, // switch
        SYMBOL_TRUE         = 44, // true
        SYMBOL_WHILE        = 45, // while
        SYMBOL_ADD          = 46, // <add>
        SYMBOL_ASSIGMENT    = 47, // <assigment>
        SYMBOL_CONTANT      = 48, // <contant>
        SYMBOL_DECLARATION  = 49, // <declaration>
        SYMBOL_DIV2         = 50, // <div>
        SYMBOL_EXP          = 51, // <exp>
        SYMBOL_FORAS        = 52, // <foras>
        SYMBOL_FORINCDEC    = 53, // <forincdec>
        SYMBOL_MUL          = 54, // <mul>
        SYMBOL_PROGRAM      = 55, // <program>
        SYMBOL_STATMENTLIST = 56, // <statmentlist>
        SYMBOL_SUB          = 57  // <sub>
    };
